...
const hajjStore = localforage.createInstance({
  name: "HajjDashboardCache",
  storeName: "hajjApplicants"
});
...
const HajjDashboard = () => {
 ...
 const fetchData = async () => {
  ...
  const CACHE_KEY = "all_hajj_applicants";
  ...
  try {
    ...
    const cached = await hajjStore.getItem(CACHE_KEY);
    ...
    if(cached){
      ...
      console.log("Loaded Hajj data from cache");
  ...
  const ref = collection(db,"hajjApplicants");
