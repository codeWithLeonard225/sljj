...
const HajjForm = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4">
        ...
        >
          <div
            className="bg-white/70 rounded-lg p-6 overflow-auto"
            style={{
              width: "210mm",
              height: "297mm",
              maxWidth: "100%",
          ...
          >
            ...
            <div className="bg-white/50 p-6 rounded-lg mb-6">
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-3">
                  {/* These are just placeholders; you'll want to make them controlled inputs too */}
                  <div>
                    <div className="flex items-center">
            ...
            <div className="bg-white/50 p-6 rounded-lg mb-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center">
                  ...
                  <label className="ml-4"><input type="radio" name="convicted" value="No" checked={formData.convicted === "No"} onChange={handleInputChange} className="mr-1" /> No</label>
                ...
                <div className="flex items-center">
                  ...
                  <label className="ml-4"><input type="radio" name="deported" value="No" checked={formData.deported === "No"} onChange={handleInputChange} className="mr-1" /> No</label>
            ...
            <div className=" bg-gray-100 px-4 py-1 rounded-full text-sm font-semibold text-blue-800">
